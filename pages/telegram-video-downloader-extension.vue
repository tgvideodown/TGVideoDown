        ...
        <div class="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <div class="flex flex-col gap-3 sm:flex-row">
              ...
              <NuxtLink :to="localePath('/telegram-video-downloader-chrome')" class="btn-outline text-center">
                {{ page.ctaSecondary }}
              </NuxtLink>
            </div>
    ...
    <section class="section-padding bg-slate-50">
      <div class="container-custom">
        <div class="grid gap-10 lg:grid-cols-2">
          ...
          <section>
            <h2 class="mb-4 text-3xl font-heading font-bold text-text">{{ page.comparisonTitle }}</h2>
            <p class="leading-relaxed text-gray-700">{{ page.comparisonText }}</p>
          </section>
        </div>
      </div>
    </section>
    ...
    <section class="section-padding bg-white">
      <div class="container-custom">
        <div class="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-start">
          <section>
            <h2 class="mb-5 text-3xl font-heading font-bold text-text">{{ page.batchTitle }}</h2>
          ...
          <ArticleInstallCta
            ...
            secondary-path="/telegram-video-downloader-chrome"
          />
        </div>
      </div>
    </section>
...
const page = computed(() => content.value.extensionLanding)
